...
public class EjercicioDos {
    public static void main(String[] args) {
        ...
        List listPersonas = List.of(persona1, persona2, persona3, persona4, persona5, persona6, persona7, persona8, persona9, persona10, persona11, persona12);
        metodoDeclarativo(listPersonas, 25, "Acuario");
        metodoImperativo(listPersonas, 25, "Acuario");
    }
    ...
    private static void metodoImperativo(List<Persona> listPersonas, int anios, String signo) {
        ...
        List<Persona> personaAnio = listPersonas.stream().filter(o -> o.getEdad() > anios).collect(Collectors.toList());
        System.out.println("LAS PERSONAS DEL SIGNO" + signo + " SON : " + personaSigno.toString());
        System.out.println("LAS PERSONAS MAYORES DE " + anios +"  SON : " + personaAnio.toString());
    }
    ...
    private static void metodoDeclarativo(List<Persona> listPersonas, int anios, String signo) {
        ...
        System.out.println("LAS PERSONAS DEL SIGNO" + signo + " SON : " + listSigno.toString());
        System.out.println("LAS PERSONAS MAYORES DE " + anios +"  SON : " + listAnios.toString());
    }
}
