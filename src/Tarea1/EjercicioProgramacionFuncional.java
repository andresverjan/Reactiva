...
public class EjercicioProgramacionFuncional {
    ...
    public static void main(String[] args) {
        ...
        //llamando funciones para cada punto enviando lista de estudiantes
        //1. Usando el modo declarativo obtener todos los estudiantes que son de signo acuario.
        estudiantesAcuario(estudiantes);

        //2. Usando el modo declarativo obtener todos los estudiantes donde la edad es mayor a 25
        estudiantesMayores25(estudiantes);


        //3. Usando el modo imperativo obtener todos los estudiantes que son de signo acuario.
        estudiantesAcuarioImperativo(estudiantes);
        //4. Usando el modo imperativo obtener todos los estudiantes donde la edad es mayor a 25.
        estudiantesMayores25Imperativo(estudiantes);

    }
        //Funciones

    //1. Usando el modo declarativo obtener todos los estudiantes que son de signo acuario.
    static void estudiantesAcuario(List<Estudiante> estudiantes) {
    ...
    //2. Usando el modo declarativo obtener todos los estudiantes donde la edad es mayor a 25
    static void estudiantesMayores25(List<Estudiante> estudiantes) {
        System.out.println("2. Estudiantes que son mayores de 25 años modo declarativo: ");
        estudiantes.stream()
                .filter(estudiante -> estudiante.getEdad() > 25)
                .forEach(estudiante -> System.out.println(estudiante.getNombre() + " " + estudiante.getApellido() + " " + estudiante.getEdad()));
        System.out.println("**********************************: ");
    }


    //3. Usando el modo imperativo obtener todos los estudiantes que son de signo acuario.
    static void estudiantesAcuarioImperativo(List<Estudiante> estudiantes) {
    ...
    //4. Usando el modo imperativo obtener todos los estudiantes donde la edad es mayor a 25.
    static void estudiantesMayores25Imperativo(List<Estudiante> estudiantes) {
