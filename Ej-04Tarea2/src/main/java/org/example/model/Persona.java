...
public class Persona {
    ...
    private PublishSubject<String> propertyChanges = PublishSubject.create();

    public void addObserver(Observer observer) {
        propertyChanges.subscribe(propertyName ->
                observer.onNext(propertyName)
        );
    }

    private void notifyObserver(String persona) {
        propertyChanges.onNext(persona);
    }
    ...
    public static List<Persona> estudiantes(){
