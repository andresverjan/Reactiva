...
import com.co.bancolombia.collection.Person;
...
public class FuncionalProgrammingApplication {

    public static void main(String[] args) {
        SpringApplication.run(FuncionalProgrammingApplication.class, args);
